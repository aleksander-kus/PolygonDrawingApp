...
namespace lab1
{
    public static class GraphicsHelpers
    {
        ...
        public static int SquaredDistance(Shapes.Point p1, Shapes.Point p2) => (p2.X - p1.X) * (p2.X - p1.X) + (p2.Y - p1.Y) * (p2.Y - p1.Y);
        ...
        public static bool IsPointClicked(Shapes.Point point, Shapes.Point mousePosition, int epsilon = 10) => SquaredDistance(point, mousePosition) <= epsilon * epsilon;
        ...
        /// <param name="epsilon">Precision in pixels</param>
        /// <returns></returns>
        public static bool IsSegmentClicked(Shapes.Point p1, Shapes.Point p2, Shapes.Point mousePosition, int epsilon = 10) => IsPointClicked(SegmentCenter(p1, p2), mousePosition, epsilon);

        public static Shapes.Point SegmentCenter(Shapes.Point p1, Shapes.Point p2) => new Shapes.Point((p1.X + p2.X) / 2, (p1.Y + p2.Y) / 2);
